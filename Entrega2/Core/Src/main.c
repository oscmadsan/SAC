...
typedef Estado (*FuncionEstado)(void);
/* USER CODE END PTD */
...
/* USER CODE BEGIN PFP */
Estado funcionEstadoS0(void);
Estado funcionEstadoS1(void);
Estado funcionEstadoS2(void);
Estado funcionEstadoS3(void);

FuncionEstado funcionesEstado[4] = {
		funcionEstadoS0,
		funcionEstadoS1,
		funcionEstadoS2,
		funcionEstadoS3
